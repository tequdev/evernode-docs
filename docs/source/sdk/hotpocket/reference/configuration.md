...
- ### ***contract***
  >  This section contains attributes that are required in smart contract maintenance. In a particular consensus round, this block will be synced with the other nodes that are participating in the consensus.
  ...
  | ***unl***                     | The UNL (Unique Node List) is the list of the hex public keys of the trusted nodes that are participating in the consensus. Only the stage proposals sent by these trusted nodes are accepted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
  ...
  | ***npl***                     | The NPL (Node Party Line) is a peer communication method used in HotPocket.  <br> ***mode***  : This can be used to configure the communication mode as `private` or `public`. Private and public in this instance behave the same as the consensus.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
